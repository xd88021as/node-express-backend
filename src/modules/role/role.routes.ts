...
router.post('', authMiddleware, requireAdmin, validateDTO(RoleCreateDTO), async (req, res) => {
...
router.patch('', authMiddleware, requireAdmin, validateDTO(RoleUpdateDTO), async (req, res) => {
